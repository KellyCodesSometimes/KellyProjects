...
import { interactiveProjectBlocks, projectBlocks, tutorialsBlocks } from '../components/TransitionBlockDetails'
  ...
  return (
    <>
      <div className="app">
        ...
        <TransitionBlocks title={"Demos of Projects"} childBlocks={projectBlocks}/>
        <TransitionBlocks title={"Interactive Projects"} childBlocks={interactiveProjectBlocks}/>
